...
class LiveVideoStreamServiceTestSpec extends BaseTestSpec {
  var cassandraUtil: CassandraUtil = _
  val config: Config = ConfigFactory.load("test.conf")
  lazy val jobConfig: LiveVideoStreamGeneratorConfig = new LiveVideoStreamGeneratorConfig(config)
  ...
  "VideoStreamService" should "submit job request" in {
    ...
    val videoStreamService = new LiveVideoStreamService()(jobConfig, mockHttpUtil);
