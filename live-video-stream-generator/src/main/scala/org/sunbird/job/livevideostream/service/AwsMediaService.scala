...
import org.sunbird.job.livevideostream.helpers.{AwsRequestBody, AwsSignUtils, MediaResponse, Response}
...
abstract class AwsMediaService extends IMediaService {
	...
	protected def prepareJobRequestBody(jobRequest: Map[String, AnyRef])(implicit config: LiveVideoStreamGeneratorConfig, httpUtil: HttpUtil): String = {
	...
	protected def prepareInputUrl(url: String)(implicit config: LiveVideoStreamGeneratorConfig, httpUtil: HttpUtil): String = {
	...
	protected def prepareOutputUrl(contentId: String, streamType: String, pkgVersion: String)(implicit config: LiveVideoStreamGeneratorConfig): String = {
		val bucket = config.getConfig("aws.content_bucket_name")
	...
	protected def getSignatureHeader()(implicit config: LiveVideoStreamGeneratorConfig): Map[String, String] = {
	...
	protected def getDefaultHeader(httpMethod: String, url: String, payload: String)(implicit config: LiveVideoStreamGeneratorConfig): Map[String, String] = {
