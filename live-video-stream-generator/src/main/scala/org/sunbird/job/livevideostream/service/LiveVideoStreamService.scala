...
import org.sunbird.job.livevideostream.helpers.JobRequest
import org.sunbird.job.livevideostream.service.impl.MediaServiceFactory
...
import org.sunbird.job.livevideostream.helpers.{JobRequest, MediaRequest, MediaResponse, StreamingStage}

import scala.collection.JavaConverters._

class LiveVideoStreamService(implicit config: LiveVideoStreamGeneratorConfig, httpUtil: HttpUtil) {
  private[this] lazy val logger = LoggerFactory.getLogger(classOf[LiveVideoStreamService])
