...
class CreateUserFeedFunctionTest extends BaseTestSpec {
  ...
  override protected def beforeAll(): Unit = {
    ...
    when(mockHttpUtil.post(any[String], any[String])).thenReturn(HTTPResponse(200, """{"id":"api.user.feed.create","ver":"v1","ts":"2020-10-30 13:20:54:940+0000","params":{"resmsgid":null,"msgid":"518d3404-cf1f-4001-81a5-0c58647b32fe","err":null,"status":"success","errmsg":null},"responseCode":"OK","result":{"response":"SUCCESS"}}"""))
  }
  ...
  "UserFeedFunction " should "should send user feed" in {
    ...
    new CreateUserFeedFunction(userFeedConfig, mockHttpUtil).processElement(UserFeedMetaData("userId", "CourseName", new Date()), null, metrics)
