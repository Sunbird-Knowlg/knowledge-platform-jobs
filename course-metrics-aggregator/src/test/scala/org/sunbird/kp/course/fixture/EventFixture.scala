...
object EventFixture {
  ...
  val EVENT_2: String =
    """
      |{"eid":"BE_JOB_REQUEST","ets":1563788371969,"mid":"LMS.1563788371969.590c5fa0-0ce8-46ed-bf6c-681c0a1fdac8","actor":{"type":"System","id":"Course Batch Updater"},"context":{"pdata":{"ver":"1.0","id":"org.sunbird.platform"}},"object":{"type":"CourseBatchEnrolment","id":"0126083288437637121_8454cb21-3ce9-4e30-85b5-fade097880d8"},"edata":{"contents":[{"contentId":"do_R1","status":1},{"contentId":"do_R2","status":1},{"contentId":"do_R3","status":1}],"action":"batch-enrolment-update","iteration":1,"batchId":"Batch1","userId":"user001","courseId":"course001"}}
      |""".stripMargin
  ...
  //===QUERY====BEGIN BATCH UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':1},agg_last_updated=agg_last_updated+{'progress':1593612137196} WHERE activity_id='do_course_unit3' AND activity_type='course-unit' AND context_id='cb:0126083288437637121' AND user_id='8454cb21-3ce9-4e30-85b5-fade097880d8';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':1},agg_last_updated=agg_last_updated+{'progress':1593612137255} WHERE activity_id='do_course_unit2' AND activity_type='course-unit' AND context_id='cb:0126083288437637121' AND user_id='8454cb21-3ce9-4e30-85b5-fade097880d8';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':1},agg_last_updated=agg_last_updated+{'progress':1593612137259} WHERE activity_id='do_course_unit1' AND activity_type='course-unit' AND context_id='cb:0126083288437637121' AND user_id='8454cb21-3ce9-4e30-85b5-fade097880d8';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612137269} WHERE activity_id='do_1127212344324751361295' AND activity_type='course' AND context_id='cb:0126083288437637121' AND user_id='8454cb21-3ce9-4e30-85b5-fade097880d8';APPLY BATCH;
  //===QUERY====BEGIN BATCH UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612137319} WHERE activity_id='unit2' AND activity_type='course-unit' AND context_id='cb:Batch1' AND user_id='user001';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612137324} WHERE activity_id='unit1' AND activity_type='course-unit' AND context_id='cb:Batch1' AND user_id='user001';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':3},agg_last_updated=agg_last_updated+{'progress':1593612137330} WHERE activity_id='course001' AND activity_type='course' AND context_id='cb:Batch1' AND user_id='user001';APPLY BATCH;
  // UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612137319} WHERE activity_id='unit2' AND activity_type='course-unit' AND context_id='cb:Batch1' AND user_id='user001';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612137324} WHERE activity_id='unit1' AND activity_type='course-unit' AND context_id='cb:Batch1' AND user_id='user001';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':3},agg_last_updated=agg_last_updated+{'progress':1593612137330} WHERE activity_id='course001' AND activity_type='course' AND context_id='cb:Batch1' AND user_id='user001';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612137346} WHERE activity_id='unit11' AND activity_type='course-unit' AND context_id='cb:B11' AND user_id='U11';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':1},agg_last_updated=agg_last_updated+{'progress':1593612137343} WHERE activity_id='unit22' AND activity_type='course-unit' AND context_id='cb:B11' AND user_id='U11';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612137349} WHERE activity_id='C11' AND activity_type='course' AND context_id='cb:B11' AND user_id='U11';APPLY BATCH;

  //===QUERY====BEGIN BATCH UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612416135} WHERE activity_id='unit11' AND activity_type='course-unit' AND context_id='cb:B11' AND user_id='U11';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':1},agg_last_updated=agg_last_updated+{'progress':1593612416079} WHERE activity_id='unit22' AND activity_type='course-unit' AND context_id='cb:B11' AND user_id='U11';UPDATE sunbird_courses.activity_agg SET agg=agg+{'progress':2},agg_last_updated=agg_last_updated+{'progress':1593612416145} WHERE activity_id='C11' AND activity_type='course' AND context_id='cb:B11' AND user_id='U11';APPLY BATCH;
