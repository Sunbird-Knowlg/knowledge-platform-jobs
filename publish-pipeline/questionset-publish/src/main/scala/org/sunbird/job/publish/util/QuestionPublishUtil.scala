...
object QuestionPublishUtil extends QuestionPublisher {
	...
	def publishQuestions(identifier: String, objList: List[ObjectData])(implicit neo4JUtil: Neo4JUtil, cassandraUtil: CassandraUtil, readerConfig: ExtDataConfig, cloudStorageUtil: CloudStorageUtil, definitionCache: DefinitionCache, definitionConfig: DefinitionConfig): Unit = {
