...
trait DIALCodeIndexerHelper {
  ...
  def getDocument(message: Map[String, Any], updateRequest: Boolean)(
  ...
  def upsertDIALCodeDocument(identifier: String, message: Map[String, Any])(
      esUtil: ElasticSearchUtil
  ): Unit = {
