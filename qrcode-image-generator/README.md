...
1. Download flink-1.12.0-scala_2.12 from [apache-flink-downloads](https://www.apache.org/dyn/closer.lua/flink/flink-1.12.0/flink-1.12.0-bin-scala_2.12.tgz). 
...
```
./bin/flink run -m yarn-cluster -p 2 -yjm 1024m -ytm 1024m <knowledge-platform-jobs>/qrcode-image-generator/target/qrcode-image-generator-0.0.1.jar
```
...
./bin/flink run -m localhost:8081 <knowledge-platform-job>/qrcode-image-generator/target/qrcode-image-generator-0.0.1.jar
