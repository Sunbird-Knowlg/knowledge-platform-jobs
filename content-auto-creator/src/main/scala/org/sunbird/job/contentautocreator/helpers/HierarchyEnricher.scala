...
import org.sunbird.job.contentautocreator.model.ObjectData
...
trait HierarchyEnricher {
	...
	def getChildren(obj: ObjectData)(implicit config: ContentAutoCreatorConfig): Map[String, AnyRef] = {
	...
	def getChildrenMap(children: List[Map[String, AnyRef]], childrenMap: Map[String, AnyRef])(implicit config: ContentAutoCreatorConfig): Map[String, AnyRef] = {
	...
	def enrichHierarchy(obj: ObjectData, childrens: Map[String, ObjectData])(implicit config: ContentAutoCreatorConfig): ObjectData = {
	...
	def enrichChildren(children: List[Map[String, AnyRef]], chObjects: Map[String, ObjectData])(implicit config: ContentAutoCreatorConfig): List[Map[String, AnyRef]] = {
	...
	def enrichMetadata(element: Map[String, AnyRef], chObjects: Map[String, ObjectData])(implicit config: ContentAutoCreatorConfig): Map[String, AnyRef] = {
	...
	def getChildData(data: Map[String, AnyRef])(implicit config: ContentAutoCreatorConfig): Map[String, AnyRef] = {
