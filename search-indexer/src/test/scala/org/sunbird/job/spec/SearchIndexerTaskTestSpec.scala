...
//  }
  ...
  ignore should " sync the Data Node " in {
  ...
  ignore should " update the Data Node " in {
  ...
  ignore should " create and delete the Data Node " in {
  ...
  ignore should " do nothing for the Data Node due to UNKNOWN Operation " in {
    embeddedElastic.deleteIndices()
  ...
  ignore should " sync the External Dialcode Data " in {
  ...
  ignore should " update the External Dialcode Data " in {
  ...
  ignore should " create and delete the External Dialcode Data " in {
    embeddedElastic.deleteIndices()
  ...
  ignore should " do nothing for the External Dialcode Data due to UNKNOWN Operation " in {
    embeddedElastic.deleteIndices()
  ...
  ignore should " sync the Dialcode Metrics Data " in {
  ...
  ignore should " update the Dialcode Metrics Data " in {
  ...
  ignore should " create and delete the Dialcode Metrics Data " in {
    embeddedElastic.deleteIndices()
  ...
  ignore should " do nothing for the Dialcode Metrics Data due to UNKNOWN Operation " in {
  ...
  ignore should " do nothing due to UNKNOWN Node Type " in {
  ...
  ignore should " do nothing due to FALSE value of INDEX of the Data " in {
  ...
  ignore should " give error for the External Dialcode Data due to UNKNOWN objectType " in {
    embeddedElastic.deleteIndices()
  ...
  ignore should " ignore the event with restricted ObjectTypes " in {
